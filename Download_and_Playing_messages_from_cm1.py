...
GPIO.add_event_detect(24,GPIO.RISING,callback=download_and_play) # Setup event on pin 26 rising edge
GPIO.add_event_detect(22,GPIO.RISING,callback=download_and_play) # Setup event on pin 26 rising edge
