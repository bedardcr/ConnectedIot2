...
GPIO.setup(10, GPIO.IN, pull_up_down=GPIO.PUD_DOWN) #set pin 12 

GPIO.add_event_detect(12,GPIO.RISING,callback=upload_button) # Setup event on pin 10 rising edge
GPIO.add_event_detect(10,GPIO.RISING,callback=record_audio) # Setup event on pin 12 rising edge
